    ...
    <>
      ...
      >
        <CardBody className=" relative group/card dark:hover:shadow-2xl dark:hover:shadow-emerald-500/[0.1] w-full h-full ">
          <CardItem
            translateZ="20"
            className="text-5xl font-normal text-neutral-600 dark:text-white w-full h-full flex items-center justify-center"
          >
            <motion.button
              whileHover={{ scale: 1.2 }}
              whileTap={{ scale: 0.8 }}
              className="w-full h-full text-5xl font-normal text-neutral-600 dark:text-white"
              onClick={onSquareClick}
            >
              {value}
            </motion.button>
